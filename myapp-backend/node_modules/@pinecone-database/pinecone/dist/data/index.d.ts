...
export declare class Index<T extends RecordMetadata = RecordMetadata> {
     ...
     * @param paginationToken - (Optional) Pagination token to continue a previous listing operation.
     */
    listNamespaces(limit?: number, paginationToken?: string): Promise<import("../pinecone-generated-ts-fetch/db_data").ListNamespacesResponse>;
    /**
     ...
     */
    describeNamespace(namespace: string): Promise<import("../pinecone-generated-ts-fetch/db_data").NamespaceDescription>;
    /**
