...
export function getFeatures(model) {
    var _a, _b;
    return ((_b = (_a = model.features) !== null && _a !== void 0 ? _a : {
    ...
    }[model.modelId]) !== null && _b !== void 0 ? _b : (model.modelId.startsWith("prebuilt-") ? allFeatures : [...documentFeatures, "_documents"]));
}
