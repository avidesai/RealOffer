    ...
    if (field.kind === "object") {
        ...
        for (const [subFieldName, subFieldSchema] of Object.entries(schema.properties)) {
            if (field.properties[subFieldName] !== undefined && field.properties[subFieldName] !== null) {
                const trueFieldName = ((0, util_js_1.isAcronymic)(subFieldName) ? subFieldName : (0, util_js_1.uncapitalize)(subFieldName)).replace(/\s/g, "");
            ...
            function toDocument(document) {
                ...
                for (const [fieldName, fieldSchema] of Object.entries(model.fieldSchema)) {
                    if (document.fields &&
                        ...
                        const trueFieldName = ((0, util_js_1.isAcronymic)(fieldName) ? fieldName : (0, util_js_1.uncapitalize)(fieldName)).replace(/\s/g, "");
