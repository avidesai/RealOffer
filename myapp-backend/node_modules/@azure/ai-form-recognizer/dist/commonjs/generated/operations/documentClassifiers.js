...
exports.DocumentClassifiersImpl = void 0;
...
class DocumentClassifiersImpl {
    ...
    listClassifiersPagingPage(options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listClassifiersPagingPage_1() {
            let result = yield tslib_1.__await(this._listClassifiers(options));
            yield yield tslib_1.__await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield tslib_1.__await(this._listClassifiersNext(continuationToken, options));
    ...
    listClassifiersPagingAll(options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listClassifiersPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listClassifiersPagingPage(options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
exports.DocumentClassifiersImpl = DocumentClassifiersImpl;
