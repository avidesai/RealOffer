...
export interface Document {
    ...
    fields?: {
        [propertyName: string]: DocumentField;
    };
...
export declare enum KnownDocumentAnalysisFeature {
...
/** Optional parameters. */
export interface DocumentModelsAnalyzeDocument$binaryOptionalParams extends coreClient.OperationOptions {
...
/** Optional parameters. */
export interface DocumentModelsAnalyzeDocument$textOptionalParams extends coreClient.OperationOptions {
    /** Analyze request parameters. */
...
/** Optional parameters. */
export interface DocumentModelsAnalyzeDocument$jsonOptionalParams extends coreClient.OperationOptions {
    /** Analyze request parameters. */
...
/** Optional parameters. */
export interface DocumentModelsAuthorizeModelCopyOptionalParams extends coreClient.OperationOptions {
}
...
/** Optional parameters. */
export interface MiscellaneousListOperationsNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listOperationsNext operation. */
export type MiscellaneousListOperationsNextResponse = GetOperationsResponse;
/** Optional parameters. */
export interface DocumentClassifiersBuildClassifierOptionalParams extends coreClient.OperationOptions {
}
...
/** Optional parameters. */
export interface DocumentClassifiersListClassifiersOptionalParams extends coreClient.OperationOptions {
}
...
/** Optional parameters. */
export interface DocumentClassifiersGetClassifierOptionalParams extends coreClient.OperationOptions {
}
...
/** Optional parameters. */
export interface DocumentClassifiersDeleteClassifierOptionalParams extends coreClient.OperationOptions {
}
/** Optional parameters. */
export interface DocumentClassifiersClassifyDocument$binaryOptionalParams extends coreClient.OperationOptions {
    /** Classify request parameters. */
    classifyRequest?: coreRestPipeline.RequestBodyType;
}
/** Optional parameters. */
export interface DocumentClassifiersClassifyDocument$textOptionalParams extends coreClient.OperationOptions {
    /** Classify request parameters. */
    classifyRequest?: string;
}
/** Optional parameters. */
export interface DocumentClassifiersClassifyDocument$jsonOptionalParams extends coreClient.OperationOptions {
    /** Classify request parameters. */
...
/** Optional parameters. */
export interface DocumentClassifiersGetClassifyResultOptionalParams extends coreClient.OperationOptions {
}
...
/** Optional parameters. */
export interface DocumentClassifiersListClassifiersNextOptionalParams extends coreClient.OperationOptions {
}
