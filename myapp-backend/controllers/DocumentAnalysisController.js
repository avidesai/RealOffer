...
exports.analyzeDocument = async (req, res) => {
  ...
  try {
    ...
    if (!['Home Inspection Report', 'Roof Inspection Report', 'Pest Inspection Report', 'Seller Property Questionnaire', 'Real Estate Transfer Disclosure Statement', 'Agent Visual Inspection', 'Sewer Lateral Inspection', 'Natural Hazard Disclosures', 'Preliminary Title Report'].includes(document.type)) {
