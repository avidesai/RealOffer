          ...
          documents.map((doc, index) => (
            ...
            >
              ...
              <div className="docs-tab-document-actions">
                {(doc.type === 'Home Inspection Report' || doc.type === 'Pest Inspection Report' || doc.type === 'Seller Property Questionnaire' || doc.type === 'Transfer Disclosure Statement' || doc.type === 'Agent Visual Inspection Disclosure') && (
                  <button 
